...
Cette convention (ci-après "Convention") est destinée à régir, de la manière la plus complète possible, la relation de partenariat conclue entre l'association et le partenaire, en vue principalement de l’organisation de l'évènement **<%= EVENT_NAME %> <%= EVENT_EDITION %>** (ci-après
"l’Evénement").

Elle précise de façon exhaustive les droits et les obligations principaux des deux Parties, étant entendu que ceux-ci peuvent évoluer au fil du temps conformément à l'article VI - Modifications ; l’objectif principal étant que le partenariat qui unit les deux Parties se développe au maximum et dans le sens des intérêts de chacun.


## II - OBLIGATIONS DE L'ASSOCIATION


L'Association s’engage à donner une forte visibilité du partenaire sur les supports de communication Internet de l’Association :
...
Les obligations citées précédemment seront appliquées à la reception du paiement réalisé par le Partenaire. Le paiement devra être réalisé avant le 13 mai 2025. 

En outre, tout projet de communication de l'Association relatif à l'Evénement se fera sous réserve du respect par l'Association : i) de l'image de marque du Partenaire et ii) du
respecter la charte graphique communiquée par le Partenaire.

Les éventuelles licences d'utilisation de marques commerciales, noms, logos, dénomination sociale et autres signes distinctifs qui seraient accordées dans le cadre de l'Evénement par le Partenaire à 
l'Association ne le sont qu'aux fins exclusives d'exécution de la présente Convention. Elles sont concédées, le cas échéant, à titre non exclusif, non transférable et non cessible, pendant la durée de validité 
de la Convention et n'entraînent aucun transfert de droit de propriété du Partenaire à l'égard de l'Association.
...
Le présent partenariat conclu entre l'association et partenaire débutera à la signature de la présente Convention et s’achèvera de plein droit et sans formalité le <%= END_DATE %>, sous
réserve de l'application éventuelle de l'article "Résiliation".
